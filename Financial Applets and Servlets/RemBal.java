...
public class RemBal extends JFrame implements ActionListener {
    ...
    /* User pressed Enter on a text field or pressed Compute. Display the result if all fields are completed. */
    public void actionPerformed(ActionEvent ae) {
        ...
        try {
            if (orgPStr.length() != 0 && numPayStr.length() != 0 && rateStr.length() != 0 && payStr.length() != 0) {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new RemBal());
    }
}
